...
## 17. Write a program to check if a person is eligible for a loan (age > 21 and salary > 25,000).
...
if age > 21 and salary > 25000:
    ...
    print("The person is not eligible because his age is less than 21")
elif age < 21 and salary < 25000:
    print("The person is not eligible because his salary is less than 25000")
else:
    print("The person is not eligible because his age is less than 21 and his salary is less than 25000")
```
...
Enter your age 20
Enter your salary 27000
The person is not eligible because his age is less than 21
```
```text
Enter your age 22
Enter your salary 1000
The person is not eligible because his age is less than 21 and his salary is less than 25000
```
```text
Enter your age 24
Enter your salary 1000
The person is not eligible because his salary is less than 25000
```

---

## 18. Write a program to determine if a number is divisible by 3, 5, or both.

```python
num = int(input("enter the number"))

if num % 3 == 0 and num % 5 != 0:
    print(f"The {num} is divisible by 3 but not 5")
elif num % 3 != 0 and num % 5 == 0:
     print(f"The {num} is divisible by 5 but not 3")
elif num % 3 == 0 and num % 5 == 0:
     print(f"The {num} is divisible by both 5 and 3")
else:
     print(f"The {num} is not divisible by both 5 and 3")
```
...
```text
enter the number 9
The 9 is divisible by 3 but not 5
```
```text
enter the number 10
The 10 is divisible by 5 but not 3
```
```text
enter the number 15
The 15 is divisible by both 5 and 3
```
```text
enter the number 8
The 8 is not divisible by both 5 and 3
```

---

## 19.Write a program to check login credentials (username and password).
...
if inp_username != username and inp_password == password:
    print("Username is incorrect. Login Failed!")
elif inp_username == username and inp_password != password:
    print("Password is incorrect. Login Failed!")
elif inp_username == username and inp_password != password:
    print("Both username and password are correct. Login Successfull!")
else:
    print("Both username and password are incorrect. Login Failed!")
```

Output:-

```text
enter the username saha
enter the password 3001
Username is incorrect. Login Failed!
```
```text
enter the username sahanar
...
enter the username sahanar
enter the password 3001
Both username and password are correct. Login Successfull!
```
```text
enter the username sahana
enter the password 300
Both username and password are incorrect. Login Failed!
```

---

## 20. Write a program to calculate BMI and categorize it (Underweight, Normal, Overweight, Obese).
...
```
```text
Enter the height in meters 1.4
Enter the weight in kg 56
You are Overweight
```
```text
Enter the height in meters 1.88
Enter the weight in kg 74.84
